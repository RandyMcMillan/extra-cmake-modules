...
function (ecm_set_disabled_deprecation_versions)
    ...
    foreach (it RANGE ${number_pairs})
        ...
        _ecm_version_tripel_sanity_check("${DEPRECATION_VERSION}")
...
function(_ecm_geh_generate_hex_number_from_version _var_name _version)
    ...
    math(EXPR _hexnumber "${CMAKE_MATCH_1}*65536 + ${CMAKE_MATCH_2}*256 + ${CMAKE_MATCH_4}" ${_outputformat})
    set(${_var_name} ${_hexnumber} PARENT_SCOPE)
endfunction()

function (_ecm_version_tripel_sanity_check unchecked_version)
    # helper string
