...
function(ecm_target_qml_sources ARG_TARGET)
    ...
    foreach(_file ${ARG_SOURCES})
        if (NOT EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${_file})
            message(FATAL_ERROR "ecm_target_qml_sources called with nonexistant file ${_file}")
        endif()
        ...
        set_property(TARGET ${ARG_TARGET}
            APPEND PROPERTY ${_ECM_QMLMODULE_PROPERTY_FILES} ${CMAKE_CURRENT_SOURCE_DIR}/${_file}
        )
    endforeach()
endfunction()
