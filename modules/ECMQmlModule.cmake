...
set(_ECM_QMLMODULE_PROPERTY_SINGLETON "QT_QML_SINGLETON_TYPE")
...
function(_ecm_qmlmodule_generate_qmldir ARG_TARGET)
    ...
    foreach(_file ${_qml_files})
        ...
        get_property(_singleton SOURCE ${_file} PROPERTY ${_ECM_QMLMODULE_PROPERTY_SINGLETON})
