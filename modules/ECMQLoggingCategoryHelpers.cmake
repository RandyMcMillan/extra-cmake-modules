...
")
    ...
    foreach(_category IN LISTS ARG_CATEGORY_NAMES)
        ...
        if(_open_namespaces)
            file(APPEND ${_header_file} "${_open_namespaces}\n")
            file(APPEND ${_source_file} "${_open_namespaces}\n")
        endif()
        file(APPEND ${_header_file} "Q_DECLARE_LOGGING_CATEGORY(${_identifier})\n")
        file(APPEND ${_source_file} "Q_LOGGING_CATEGORY(${_identifier}, \"${_category}\", Qt${_default_severity}Msg)\n")
        if(_close_namespaces)
            file(APPEND ${_header_file} "${_close_namespaces}\n")
            file(APPEND ${_source_file} "${_close_namespaces}\n")
        endif()
    endforeach()
