...
macro(ecm_add_qtdesignerplugin target)
    ...
    if (NOT TARGET Qt${QT_MAJOR_VERSION}::UiPlugin)
        message(FATAL_ERROR "The ECMAddQtDesignerPlugin CMake module was included, but Qt${QT_MAJOR_VERSION}::UiPlugin"
                            " could not be found, the Qt Designer plugins will not be created.")
    else()
