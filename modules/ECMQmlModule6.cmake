...
function(ecm_add_qml_module ARG_TARGET)
    cmake_parse_arguments(PARSE_ARGV 1 ARG "NO_PLUGIN;QT_NO_PLUGIN" "URI;VERSION;CLASSNAME" "")
    ...
    if (ARG_NO_PLUGIN)
        message(AUTHOR_WARNING "The NO_PLUGIN argument to ecm_add_qml_module is deprecated for Qt 6; For Qt 6 QML modules always require a plugin library.")
    endif()
...
function(ecm_target_qml_sources ARG_TARGET)
    ...
    foreach(_path ${ARG_SOURCES})
        ...
        qt_target_qml_sources(${ARG_TARGET} QML_FILES "${_path}" ${ARG_UNPARSED_ARGUMENTS})
    endforeach()
endfunction()
