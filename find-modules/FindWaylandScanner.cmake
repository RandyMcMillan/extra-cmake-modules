...
function(ecm_add_wayland_client_protocol target_or_source_var)
    # Parse arguments
    ...
    if (TARGET ${target_or_source_var})
        target_sources(${target_or_source_var} PRIVATE "${_client_header}" "${_code}")
    else()
        list(APPEND ${target_or_source_var} "${_client_header}" "${_code}")
        set(${target_or_source_var} ${${target_or_source_var}} PARENT_SCOPE)
    endif()
endfunction()


function(ecm_add_wayland_server_protocol target_or_source_var)
    # Parse arguments
    set(oneValueArgs PROTOCOL BASENAME)
    cmake_parse_arguments(ARGS "" "${oneValueArgs}" "" ${ARGN})
    ...
    ecm_add_wayland_client_protocol(${target_or_source_var}
    ...
    if (TARGET ${target_or_source_var})
        target_sources(${target_or_source_var} PRIVATE "${_server_header}")
    else()
        list(APPEND ${target_or_source_var} "${_server_header}")
        set(${target_or_source_var} ${${target_or_source_var}} PARENT_SCOPE)
    endif()
endfunction()
